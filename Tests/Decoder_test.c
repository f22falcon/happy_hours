...
void decoder_test(void)
{
    ...
    */
    ...
    memory_write8(0x0001, 0xFF);

    memory_write8(0x0002, 0xFF);
    memory_write8(0x0003, 0xB8);

    memory_write8(0x0004, 0x00);
    memory_write8(0x0005, 0x80);

    memory_write8(0x0006, 0xBB);
    memory_write8(0x0007, 0xFF);
    memory_write8(0x0008, 0xFF);
    memory_write8(0x0009, 0xF7);
    memory_write8(0x000A, 0xFB);
