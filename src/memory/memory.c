...
uint8_t memory_read8(uint32_t address){
    if (address >MEMORY_SIZE){
        fprintf(stdrr,"Memory Read Error: 0x%05X\n ,adress");
        exit(EXIT_FAILURE);
    }
    return memory[address & 0xFFFFF];
}
uint16_t memory_read8(uint32_t address){
    if (address >MEMORY_SIZE){
        fprintf(stdrr,"Memory Read Error: 0x%05X\n ,adress");
        exit(EXIT_FAILURE);
    }
...
uint8_t memory_write8(uint32_t address,uint8_t value){
    if (address >MEMORY_SIZE){
        fprintf(stdrr,"Memory Read Error: 0x%05X\n ,adress");
        exit(EXIT_FAILURE);
    }
...
uint16_t memory_write16(uint32_t address,uint16_t value){
    if (address > MEMORY_SIZE){
        fprintf(stdrr,"Memory Read Error: 0x%05X\n ,adress");
        exit(EXIT_FAILURE);
    }
